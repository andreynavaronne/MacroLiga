function quantosMinutos(hora){
  ...
  function buscarFaixa(horaMedia, jogadores, posicao){
    ...
    var temposFaixas = ss.getRange(2,1,25,1).getValues();
  ...
  function maisHoras(){
    var ss = SpreadsheetApp.getActive().getSheetByName('Jogadores');
    let numJog = ss.getLastRow();
    var temposJogadores = ss.getRange(2,3,numJog,3).getValues();
    var nomeJogadores = ss.getRange(2,1,numJog,1).getValues();
  ...
  function adicionaJogadores(nomeJogador, horas, pontos){
    var ss = SpreadsheetApp.getActive().getSheetByName("Jogadores");
    let ultJog = ss.getLastRow()
    var nomes = ss.getRange(2,1,ultJog,1).getValues();
    let posicao = 0;
  ...
  function calculaPontos() {
    ...
    var nomesJogadores = sslista.getRange(1,5,1,16).getValues();
        ...
        if(nomeAtual.includes('-')){
          ...
          for(let j=0; j<nomesEmpates.length; j++){
            ...
            if(verificaJogador(nomeE)){
              ...
              tempoJog = 10*(Math.ceil(tempoJog/10));
              let somaEmp = 0;
              ...
              ssJogadores.getRange(coluna-3, 3).setValue(tempoTotal);
              ...
              if(temConvidado(nomeE)){
                ...
                for(let l=0; l<nomesEmpates.length; l++){
                  tempoX = 10*(Math.ceil(tempoMedia/10));
    ...
    if(ultJogoC == 1){
      for(let b = 2; b<ultJogadorC+1; b++){
        ...
        if(valorJogo == 0){
          var valor = 0;
          ssTempo.getRange(b, 2).setValue(valor);
        }else{
